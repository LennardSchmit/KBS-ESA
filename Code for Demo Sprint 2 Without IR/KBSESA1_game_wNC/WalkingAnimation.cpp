...
//Head of player when moving down
uint8_t Down[8][12] = {
    ...
    };//Head of player walking sideways
    ...
    };//Feet of player walking sideways
    ...
    };//Feet of player standing sideways
...
//This function chooses how to print the 2d arrays
void WalkingAnimation::drawCharacter(int x, int y, uint8_t mirrorTop, uint8_t mirrorBottom, uint8_t characterTop[8][12], uint8_t characterBottem[8][12]){
  ...
  //Checks if the head needs to be mirrored
  if(!mirrorTop)
  {
  ...
  //check if the bottom needs to be mirrored
  y+=8;
  if(!mirrorBottom)
  {
...
//This function prints the given array on the right location
void WalkingAnimation::drawPart(int x, int y, uint8_t part[8][12]){
  //This prints the green character
  if(player==1){
    for(int i = 0; i < 8; i++){
  		for(int p = 0; p < 12; p++){
        switch(part[i][p]){
...
//Same as the function above but mirrored
...
//Easy function to print the player walking right
...
//Easy function to print the player walking left
...
//Function to print the player standing still facing forward
