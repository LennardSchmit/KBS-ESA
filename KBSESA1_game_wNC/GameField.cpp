...
void GameField::updateGameField_pl_nc(){
	lcd->fillRect(pl_nc->getOldXPosPx() + OFFSETX, pl_nc->getOldYPosPx() + OFFSETY, SIZE, SIZE, BLACK);	//draw background
...
void GameField::updateGameField_pl_ir(){
  lcd->fillRect(pl_ir->getOldXPosPx() + OFFSETX, pl_ir->getOldYPosPx() + OFFSETY, SIZE, SIZE, BLACK); //draw background
